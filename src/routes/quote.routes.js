...
import { postQuote,getQuote,approveQuote,rejectQuote,editQuote,getMyQuotes,getAllQuotes,deleteQuote,getQuoteStats,getSingleQuote } from "../controllers/quote.controller.js";
...
router.get('/quote/:id',authenticate, getSingleQuote)
